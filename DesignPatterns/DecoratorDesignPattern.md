...
- The Decorator Design Pattern is used to add new functionalities to an existing object at run time without modifying the structure of the existing objects. 
